        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Aqui você cria e salva a sua landing page.</p>
                    <div class="mt-4 space-x-2">
                        <a href="{{ route('landing.edit') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md">Editar Minha Página</a>
